import{P as h,o as g,i as y,f as v,t as d,b as u,j as w,k as S}from"./main-u_Qm-fHq.js";let l=null,n=null;document.addEventListener("DOMContentLoaded",()=>{q(),L(),c(),C()});function q(){const t={},s=new Set;h.forEach(e=>{e.variants&&e.variants.colors&&e.variants.colors.forEach(r=>{t[r.name]=r.value}),e.variants&&e.variants.sizes&&e.variants.sizes.forEach(r=>s.add(r))});const a=document.querySelector("#color-filter-list"),i=document.querySelector("#size-filter-list");a.innerHTML=Object.entries(t).map(([e,r])=>`
