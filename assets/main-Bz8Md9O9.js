import{i as p,f as d,j as g,t as c,b as l,k as v,P as m}from"./main-C3oxpv68.js";document.addEventListener("DOMContentLoaded",()=>{h(),f(),w()});function h(){const r=document.querySelector("#trending-grid");if(!r)return;const s=m.slice(0,4);r.innerHTML=s.map(t=>{const i=p(t.id),a=t.salePrice!==void 0;return`
